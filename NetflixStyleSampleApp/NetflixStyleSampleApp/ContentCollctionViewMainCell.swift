//
//  ContentCollctionViewMainCell.swift
//  NetflixStyleSampleApp
//
//  Created by Finley on 2022/04/20.
//

import UIKit

class ContentCollctionViewMainCell: UICollectionViewCell{
    ...
    override func layoutSubviews() {
        ...
        //버튼배열
        [plusButton, plusButton, infoButton].forEach{
